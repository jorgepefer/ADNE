...
def get_all_subfolders(folder_path):
    """Get a list of all subfolders and their respective subfolders in a folder.

    Args:
        folder_path (str): Path to the folder.

    Returns:
        all_subfolders (list): List of all subfolders and their respective subfolders.
    """
    # Initialize an empty list to store all subfolders
    all_subfolders = []

    # Walk through the directory tree starting from folder_path
    for root, dirs, _ in os.walk(folder_path):
        # Add all subfolders in the current directory (root)
...
all_subfolders = get_all_subfolders(folder_path)
print("All subfolders:", all_subfolders)
