...
def load_data(train_dir, valid_dir, test_dir, batch_size, img_size):
    ...
    Args:
        ...
        valid_dirs: Path to the validation dataset.
    ...
    Returns:
        ...
        test_loader: DataLoader with the test dataset.
        num_classes: Number of classes in the dataset.
    """
    ...
    train_data = datasets.ImageFolder(train_dir, transform=train_transforms)#Objeto ImageFolder que saca todas las imágenes y clases de la carpeta de training.
